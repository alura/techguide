import { TypeNode, VariableNode, NameNode, ValueNode, DirectiveNode } from 'graphql';
import { NormalizedScalarsMap, ConvertNameFn, ParsedEnumValuesMap, ParsedDirectiveArgumentAndInputFieldMappings } from './types';
